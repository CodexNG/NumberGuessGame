...
namespace Game
{
    class Program
    {
        ...
        {
            Console.WriteLine("Welcome to Elvis's Guessing Game");
            Console.WriteLine("We have three levels, 1- Easy, 2- Medium, 3- Difficult");
            Console.WriteLine("1. Easy: You guess between 1 - 10, You get 6 guesses");
            Console.WriteLine("2. Medium: You guess between 1 - 20, You get 4 guesses");
            Console.WriteLine("3. Difficult: You guess between 1 - 50, You get 3 guesses");

            //To minimize errors, users will input the number corresponding to a level
            int level = 0;
            Console.Write("choose the number in front of your desired level (1, 2 or 3): ");
            ...
            for (int i = 1; i <= tries; i++)
            {
                ...
                {
                    Console.WriteLine("That was wrong. You have used up all your guesses.");
